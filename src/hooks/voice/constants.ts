...
export const SHERPA_STREAM_SILENCE_FINISH_MS = 2_400
export const SHERPA_STREAM_ENDPOINT_FINALIZE_MS = 1200
export const SHERPA_STREAM_RISKY_ENDPOINT_FINALIZE_MS = 1800
