...
/** @deprecated No local sensevoice providers in cloud-only build. Always returns false. */
export function isSenseVoiceSpeechInputProvider(_providerId: string) {
  return false
}

/** @deprecated No local paraformer providers in cloud-only build. Always returns false. */
export function isParaformerSpeechInputProvider(_providerId: string) {
  return false
}
...
/** @deprecated No local omnivoice providers in cloud-only build. Always returns false. */
export function isOmniVoiceSpeechOutputProvider(_providerId: string) {
  return false
}
...
export function normalizeSpeechOutputApiBaseUrl(_providerId: string, baseUrl: string) {
  return normalizeHttpBaseUrl(baseUrl)
}
