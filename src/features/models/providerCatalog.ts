...
export const API_PROVIDER_PRESETS: ApiProviderPreset[] = [
  ...
  },
  {
    ...
    notes: 'Qwen via DashScope China OpenAI-compatible mode. qwen3.7-plus is the balanced default; qwen3.8-max / qwen3.7-max are the Max flagships when higher reasoning cost is acceptable.',
    protocol: 'openai-compatible',
    requiresApiKey: true,
  },
  {
  ...
  },
  {
    ...
    notes: 'Z.ai China preset (open.bigmodel.cn). GLM-5.2 is the current 1M-context flagship. Use Z.ai Global for api.z.ai keys.',
    protocol: 'openai-compatible',
    requiresApiKey: true,
  },
  {
    ...
    notes: 'Z.ai international preset (api.z.ai). Use the China preset for open.bigmodel.cn keys.',
    protocol: 'openai-compatible',
    requiresApiKey: true,
  },
  {
